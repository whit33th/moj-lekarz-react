...
function useAvailableSlots({ city, specialty, date, visitType, limit, page, select }) {

	const { data, isLoading, refetch } = useQuery({
		queryKey: ['searchAppointments', city, specialty, date, visitType, limit, page],
		queryFn: () => patientService.availableSlots(city, specialty, date, visitType, limit, page),
