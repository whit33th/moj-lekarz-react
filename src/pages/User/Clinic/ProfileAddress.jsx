    ...
    >
      ...
      >
        {isLoading ? (
          ...
          [
            { icon: imgIcon1, text: `${data.address?.street} ${data.address?.home}${data.address?.flat ? `/${data.address?.flat}` : ""}, ${data.address?.city}, ${data.address?.province} ${data.address?.post_index}` },
