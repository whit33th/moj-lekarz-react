...
function PatientList({ setModalActive, setModalContent }) {
	...
	const modalContentInfo = (
		<div>
			...
			<BlueBorderBtn>Anuluj</BlueBorderBtn>
					...
					<thead>
						<tr>
							...
							<th className={styles.buttonAddTh} >
								<button onClick={handleOpenModal} className={`${styles.buttDefold} ${styles.fillBlue}`} id="add-prescriptions">Dodaj</button>
