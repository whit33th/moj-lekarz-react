...
function App() {
  ...
  const [modalActive, setModalActive] = useState(false) // Изменено здесь
  ...
  const doctorRoutes = (
    <Routes>
      ...
      <Route path="/recipes" element={<Recipes modalActive={modalActive} setModalActive={setModalActive} setModalContent={setModalContent} />} />
  ...
  return (
    <Router>
      <ScrollToTop />
      <Sidebar modalActive={modalActive} setModalActive={setModalActive} setModalContent={setModalContent} role={role} />
      <div className="container">
        <Navbar />
        {role === 'doctor' && doctorRoutes}
        {role === 'admin' && adminRoutes}
        {role === 'firm' && firmRoutes}
        <Modal modalContent={modalContent} modalActive={modalActive} setModalActive={setModalActive} />
